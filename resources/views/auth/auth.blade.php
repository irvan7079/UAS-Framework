...
@section('content')
    <div class="flex">
        <img src="{{ asset('assets/images/login.jpg') }}" alt=""
            class="w-3/5 h-screen object-cover brightness-70">
        <div class="w-2/5 h-screen bg-yellow-800 flex justify-center items-center">
            <div class="absolute w-2/5 h-auto right-24 bg-[#8d6624] rounded-xl flex flex-col overflow-hidden divide-y-2">
                <div class="flex justify-around">
                    <h1 class="w-full pt-8 pb-6 font-bold text-3xl text-center text-white">Login</h1>
                </div>
                    ...
                    <form action="{{ route('login.action') }}" method="post" class="w-full flex flex-col items-start">
                        ...
                        <div class="w-full relative">
                            ...
                            <input type="username" name="username" placeholder="Username"
                                class="w-full ps-12 pe-4 py-2 bg-gray-800 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-yellow-500 text-white">
                        </div>
                        ...
                        <div class="w-full flex justify-between mt-4">
                            <span class="text-sm">Don't have an account?
                                <a href="{{ route('register') }}" class="text-sm text-end text-yellow-500 hover:font-medium">
                                    Register here</a>
                            </span>
                        </div>
                        <button type="submit"
                            class="w-full h-auto py-4 mt-16 text-white font-medium bg-yellow-600 rounded-md flex justify-center items-center hover:bg-yellow-400 duration-200">Masuk
                        </button>
                    </form>
                </div>
            </div>
